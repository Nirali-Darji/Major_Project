...
//       [type]: material,
//     }));
//     store.updateTexture(type, material);
//   };
...
//                   <img
//                     src={
//                       selectedMaterials[index]?.imageURL || substyle.imageURL
//                     }
//                     alt={substyle.name}
...
//                       selectedMaterials[index]?.name === material.name
//                         ? "border-blue-500"
//                         : "border-transparent"
//                     }`}
//                     onClick={() => handleMaterialSelect(substyle.name, material.material)}
//                   >
//                     <img
...
const TinyHomeSelector = () => {
  ...
  const handleMaterialSelect = (substyleName, material) => {
    ...
    store.updateTexture(substyleName, material.samplePreviewUrl);
  };
              ...
              <div className="flex justify-center mt-2">
                {substyle.materialList.map((material, matIndex) => (
                  <div
                    ...
                    onClick={() => handleMaterialSelect(substyle.name, material)}
                  >
                    <img
                      src={material.imageURL}
                      alt={material.name}
