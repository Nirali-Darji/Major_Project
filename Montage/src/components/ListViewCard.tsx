...
const ListViewCard = ({ design, index }) => {
    ...
    return (
        <div className="flex items-center justify-between w-full mx-2 p-4 rounded-lg bg-white shadow-sm hover:shadow-md border border-transparent hover:border-black transition relative group">
